...
# 2764 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\pic_as_chip_select.inc" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\proc\\pic16f886.inc" 1 3
# 48 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\proc\\pic16f886.inc" 3
INDF equ 0000h
...
EECON2 equ 018Dh
# 2659 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\proc\\pic16f886.inc" 3
...
# 2764 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\pic_as_chip_select.inc" 2 3
...
main:
    BANKSEL TRISA
    bcf ((TRISA) and 07Fh),TRISA_TRISA0_POSITION ; Make PORTA bit ((PORTA) and 07Fh), 0 an output
loop:
    BANKSEL PORTA
    bcf ((PORTA) and 07Fh),PORTA_RA0_POSITION ; Make PORTA bit ((PORTA) and 07Fh), 0 LOW
    call WaitOnTimer0
    bsf ((PORTA) and 07Fh),PORTA_RA0_POSITION ; Make PORTA bit ((PORTA) and 07Fh), 0 HIGH
    call WaitOnTimer0
    goto loop
;
